...
result_f1_1 = -1*(155*harsh_result + 10)
...
def learn():
    ...
    for ra in range(100):
        for i in range(1):
            ...
            pop.add_reporter(neat.Checkpointer(generation_interval=100, filename_prefix='results/neat-checkpoint'+str(seed) + "_" + str(ra)+"_"+data_value+"_"+str(learningStepCount)+"-"))
