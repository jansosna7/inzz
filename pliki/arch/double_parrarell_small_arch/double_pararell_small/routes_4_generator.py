...
for rou in range(6,24):
    nr = 1
    for begin in range(0,700,50):
        mid = 0.195
        prob = mid + (nr/100) + random.uniform(-mid, mid)
        rows.append([nr, begin, begin+52, prob, rou])
        nr = nr + 1
