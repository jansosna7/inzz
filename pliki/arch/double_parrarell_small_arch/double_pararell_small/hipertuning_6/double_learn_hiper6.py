...
result_f3_1 = -1*(176*harsh_result - 5)
result_f4 = -237
...
def learn():
    ...
    conn_add_probs = [0.33, 0.4, 0.5, 0.6, 0.7]
    conn_del_diff = [0.99, 0.98, 0.95, 0.9, 0.8, 0.66, 0.5]
    node_add_probs = [0.05, 0.1, 0.2, 0.33, 0.4, 0.5]
    node_del_diff = [0.99, 0.98, 0.95, 0.9, 0.8, 0.66, 0.5]
    activations = [0.3]
    aggregations = [0, 0.05, 0.1]
    ...
    stagnation = [13, 18, 22, 31, 35]
    species_elitism = [3]
    elitism = [0, 1, 2]
    species_size = [14,15,16,17,18]
    ...
    for ra in range(100):
        for i in range(1):
            ...
            winner = None
            try:
                for generations in [60000/pop_size]:
                    gen += generations
