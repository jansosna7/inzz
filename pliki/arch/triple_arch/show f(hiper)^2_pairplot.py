...
data = pd.read_excel("hipertuning_6.xlsx")

# Separate the score from parameters
score = data.iloc[:, 0]  # Assuming the score is in the first column
parameters = data.iloc[:, 1:11]  # Assuming parameters start from the second column
...
plt.savefig("pairplot_with_colorbar.png", dpi=300)  # You can change the filename and DPI as needed
