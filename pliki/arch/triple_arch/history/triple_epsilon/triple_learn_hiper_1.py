...
def repeat_learn():
    ...
    data = [[0.05, 2,   1.2],[0.05, 1.8, 1.25],[0.05, 1.5, 1.15],[0.05, 1.5, 1.15]]
    for a,b,c in data:
        try:
            epsilon = a
            harsh_time = b
