...
def run_sim(num,nettype):
    ...
    summary_file = "control_summaries//"+"summary_"+street_net_name+nettype+num+".xml"
    tripinfos_file = "control_summaries//"+"tripinfos_"+street_net_name+nettype+num+".xml"
    xml_content = '''<?xml version="1.0" encoding="UTF-8"?>
    <configuration xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="http://sumo.dlr.de/xsd/sumoConfiguration.xsd">
        <input>
            <net-file value="'''+street_net_name+nettype+'''.net.xml"/>
